...
<template>
    <Disclosure as="nav" class="bg-white fixed w-[100%] z-10" v-slot="{ open }">
        <div class="mx-auto md:max-w-7xl py-4 justify-center w-[100%] px-2 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <div>
                    <RouterLink to="/" class="flex items-center">
                        <img class="h-8 w-8 md:h-32 md:w-32 rounded-full" src="~/assets/logo.png" alt="Workflow" />
                        <span class="text-[#0065f2] text-2xl font-extrabold pl-3">Mesfin</span>
                    </RouterLink>
                </div>
        ...
        <DisclosurePanel class="sm:hidden shadow-md">
            <div class="space-y-1 px-2 pt-2 pb-3">
                ...
                <DisclosureButton as="a" href="/chat"
