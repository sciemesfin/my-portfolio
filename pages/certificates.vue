<template>
  <div class="pt-20 md:pt-32">
    ...
    >
    <h1 class="text-xl my-8 text-center md:text-7xl font-extrabold py-2">Certicates & Awards</h1>
      <div class="md:flex md:flex-wrap h-full">
        ...
        >
          <div  class="h-full max-h-[550px] cursor-pointer bg-white shadow-md border border-gray-200 rounded-lg">
            <img
              :src="item.image"
              alt=""
              class="object-contain h-full max-h-[548px]"
            />
          </div>
        </div>
      </div>
