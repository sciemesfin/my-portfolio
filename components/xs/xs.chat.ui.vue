<template>
  <div class="fixed">
    <Disclosure
      as="nav"
      class="bg-white fixed border-b w-[100%] z-10"
      v-slot="{ open }"
    >
      <div
      ...
      >
        <div class="flex justify-between items-center">
          <div>
            <nuxt-link
              href="/"
              class="text-blue-600 flex items-center rounded-full cursor-pointer"
              aria-label="Close"
            >
              <svg
            ...
            >
              <span v-for="(nav, i) in navigation" :key="i">
                <NuxtLink
                  ...
                  :class="
                    nav.current
                      ? 'flex text-gray-600 cursor-pointer transition-colors duration-300 font-semibold text-blue-600'
          ...
          <div class="flex items-center space-x-5 hidden md:flex">
            ...
            >
              ChatGPT
              <span class="text-white pl-2" aria-hidden="true">&rarr;</span>
            </RouterLink>
          </div>
        ...
        <div class="space-y-1 px-2 pt-2 pb-3">
          <DisclosureButton
            ...
            :class="[
              item.current
                ? 'text-blue-600'
                : ' text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300',
        ...
        <section class="fixed bottom-0 bg-green-100 w-full h-[100px] p-3">
          <div class="flex items-between">
            ...
            <div>
              <button
                type="button"
                class="p-2 ml-2 text-white bg-blue-600 shadow rounded-full hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring"
...
const navigation = [
  ...
  { name: "Certifications", href: "/certificates", current: false },
